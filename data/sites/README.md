...
`outputs/review-images/` keeps images generated by OpenFloodAI, such as baseline, changed, comparison, and watched-area overlay images.
...
Overlay images draw a visible box around the watched reference region.

Simple example: if OpenFloodAI watches the lower half of a bridge pillar, the overlay image should show a box around that exact area.
